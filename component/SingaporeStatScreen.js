...
class SingaporeStatScreen extends React.Component{
    constructor() {
        super()
        this.state = {
            SingaSum:[],
    ...
    getApiSumm = async () => {
        ...
        const response = await fetch('https://covid19.mathdro.id/api/countries/Singapore')
        ...
        this.setState({SingaSum:totalData,refreshing:false})
     }
    ...
    render() {
        return(
            ...
            >
                <Header
                    centerComponent={{ text: 'Singapore Statistic', style: { color: '#fff',fontWeight:'bold' } }}
                    containerStyle={{
                ...
                <Card 
                    containerStyle={styles.cardContainer}
                >
                    <Text style={styles.styleText}>Singapore Summary</Text>
                       <FlatList
                            horizontal
                            data={this.state.SingaSum}
                            keyExtractor={(_, index) => index.toString()}
                    ...
                    <Button
                        ...
                        onPress={() => Linking.openURL('https://covid19.mathdro.id/api/countries/Singapore/og')}
                    />
                </Card>
...
export default SingaporeStatScreen