...
class GlobalStatScreeen extends React.Component {
    constructor() {
        super()
        this.state = {
            dataCovid:[],
    ...
    render(){
        return(
            ...
            <Header
                centerComponent={{ text: 'Global Statistic', style: { color: '#fff',fontWeight:'bold' } }}
                containerStyle={{
            ...
            />
                ...
                >
                    ...
                    <Button
                        ...
                        onPress={() => Linking.openURL('https://covid19.mathdro.id/api/og')}
                    />
                ...
                >
                    ...
                    <Image 
                        source={require('../assets/tips_who.png')}
...
export default GlobalStatScreeen